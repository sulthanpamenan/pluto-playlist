...
def get_pluto_session():
    """Fetch official session token from Pluto TV boot endpoint"""
    ...
    try:
        ...
        if res.status_code == 200:
            ...
            print(f"[INFO] Token acquired successfully: {token[:20]}...")
...
def build_m3u():
    ...
    print("[SUCCESS] Files `playlist.txt` and `playlist.m3u` updated successfully!")
