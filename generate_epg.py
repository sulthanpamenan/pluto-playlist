...
def generate_pluto_epg():
    print("[*] Mengambil data EPG dari API Pluto TV...")
    
    # Menggunakan relay proxy agar request GitHub Actions tidak di-block Pluto TV
    url = "https://api.allorigins.win/raw?url=https://api.pluto.tv/v2/channels"
    channels = []
    ...
    print(f"[SUCCESS] File `epg.xml` berhasil dibuat ({channel_count} channel, {programme_count} acara).")
